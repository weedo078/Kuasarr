...
def validate_session(session, config):
    """
    Validiert eine DL-Session durch PrÃ¼fung einer echten Thread-Seite
    """
    try:
        ...
        # Verwende einen bekannten Thread fÃ¼r Better Call Saul
        ...
        login_indicators = [
            'Sie mÃ¼ssen sich registrieren',   # Registrierungs-Text
        ...
        # PrÃ¼fe auf Erfolgs-Indikatoren
        success_found = []
        for indicator in success_indicators:
            if indicator in thread_response.text:
                success_found.append(indicator)
        
        # PrÃ¼fe auf Download-Indikatoren
        download_found = []
        ...
        # Debug: Speichere einen Teil der Thread-Seite fÃ¼r Analyse
        ...
        return False  # Vorsichtiger: bei Unklarheit als ungÃ¼ltig betrachten
